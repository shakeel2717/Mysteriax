<form method="POST" action="{{ route('register') }}" id="register-form">
    ...
    <input type="text" name="refer" id="refer" value="{{ $refer }}">
            ...
            <div class="">
                ...
                <label class="custom-control-label" for="tosAgree">
                    <span>{{ __('I agree to the') }} <a
                            href="{{ route('pages.get', ['slug' => 'terms-and-conditions']) }}">{{ __('Terms of Use') }}</a>
                        {{ __('and') }} <a
                            href="{{ route('pages.get', ['slug' => 'privacy']) }}">{{ __('Privacy Policy') }}</a>.</span>
                </label>
            </div>
        </div>
    </div>
